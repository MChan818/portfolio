			...
			<>
				<div className="w-1/3 h-full">
					<img
						...
						width={200}
						height={48}
						className="rounded border-2 border-slate-200/10 transition object-scale-down group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
						loading="lazy"
						decoding="async"
					/>
				</div>
